...
// Distance sensor
#define _DIST_ALPHA 0.25   //[3054] 센서 보정정도
          // [3131] EMA필터값
// Servo range
#define _DUTY_MIN 1000    // [3052] 서보의 최소각도를 microseconds로 표현
#define _DUTY_NEU 1410    // [3070] 레일플레이트 중립위치를 만드는 서보 duty값
#define _DUTY_MAX 1820                //[3062] 서보의 최대각도의 microseconds의 값
...
// PID parameters
#define _KP 1.7  // [2635] P 이득 비율(?)
#define _KI 0.017   // [2635] I 이득 비율
#define _KD 43.0 // [2635] D 이득 비율
...
const float coE[] = {-0.0000126, 0.0103172, -1.3040898, 148.6041973}; // ir_cali_추헌준
...
pterm = dterm = 0; // [2635] pid 제어값에서 우선 p 만 사용하도록
iterm = -150;
...
//        dist_raw = filtered_ir_distance(); // [2635] 센서 값 받아와서 변수에 저장
        ...
        control = pterm + dterm + iterm; // [2635] control 값, i와 d는 현재 0
