...
// Framework setting
#define _DIST_TARGET 225    // [2635] 목표하는 위치
...
#define _DUTY_NEU 1430    // [3070] 레일플레이트 중립위치를 만드는 서보 duty값
#define _DUTY_MAX 1860                //[3062] 서보의 최대각도의 microseconds의 값
...
// PID parameters
#define _KP 1.3  // [2635] P 이득 비율(?)
#define _KI 0.0   // [2635] I 이득 비율
#define _KD 40.0 // [2635] D 이득 비율
...
//        dist_raw = filtered_ir_distance(); // [2635] 센서 값 받아와서 변수에 저장
        ...
        control = pterm + dterm; // [2635] control 값, i와 d는 현재 0
