...
// turn on the LED and change LED brigtness with the distance.
  if(dist_raw < 200) {
    analogWrite(PIN_LED, (200 - dist_raw)*2.55);
  }
  else {
...
float USS_measure(int TRIG, int ECHO)
{
  ...
  if(reading < dist_min || reading > dist_max) reading = dist_raw; // return recent value when out of range.
  return reading;
